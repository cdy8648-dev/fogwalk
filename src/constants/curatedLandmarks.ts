...
import { FR_CURATED } from './curated/fr';
...
export const CURATED_LANDMARKS: CuratedLandmark[] = [...KR_CURATED, ...JP_CURATED, ...TW_CURATED, ...TH_CURATED, ...VN_CURATED, ...SG_CURATED, ...HK_CURATED, ...US_CURATED, ...FR_CURATED];
